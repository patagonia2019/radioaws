...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { country_id: @district.country_id, name: @district.name } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { country_id: @district.country_id, name: @district.name } }
